...
class Orbit_Dynamics(rk4.RK4): 
    ...
    def df_dy(self, external, state): 
        ...
        dfdy[3:,0] += drdx*u(1:3)*(-3*C1/r**4 - 5*C2/r**6*T2 - 7*C3/r**8*T3 - 7*C4/r**8*T4)
        dfdy[3:,1] += drdy*u(1:3)*(-3*C1/r**4 - 5*C2/r**6*T2 - 7*C3/r**8*T3 - 7*C4/r**8*T4)
        dfdy[3:,2] += drdz*u(1:3)*(-3*C1/r**4 - 5*C2/r**6*T2 - 7*C3/r**8*T3 - 7*C4/r**8*T4)
        dfdy[3:,0] += u(1:3)*(C2/r**5*dT2_dx + C3/r**7*dT3_dx + C4/r**7*dT4_dx)
        dfdy[3:,1] += u(1:3)*(C2/r**5*dT2_dy + C3/r**7*dT3_dy + C4/r**7*dT4_dy)
        #Last edited line
        dfdy(4:6,3) += u(1:3)*(C2/r**5*dT2_dz + C3/r**7*dT3_dz + C4/r**7*dT4_dz)
        dfdy(6,1) += drdx*z*(-5*C2/r**6*2 - 7*C3/r**8*T3z - 7*C4/r**8*T4z)
        dfdy(6,2) += drdy*z*(-5*C2/r**6*2 - 7*C3/r**8*T3z - 7*C4/r**8*T4z)
        dfdy(6,3) += drdz*z*(-5*C2/r**6*2 - 7*C3/r**8*T3z - 7*C4/r**8*T4z)
        dfdy(6,1) += z*(C3/r**7*dT3z_dx + C4/r**7*dT4z_dx)
        dfdy(6,2) += z*(C3/r**7*dT3z_dy + C4/r**7*dT4z_dy)
        dfdy(6,3) += z*(C3/r**7*dT3z_dz + C4/r**7*dT4z_dz)
        dfdy(6,3) += (C2/r**5*2 + C3/r**7*T3z + C4/r**7*T4z)
